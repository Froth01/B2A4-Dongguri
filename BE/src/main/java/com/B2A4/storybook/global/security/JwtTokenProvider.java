package com.B2A4.storybook.global.security;

import com.B2A4.storybook.global.exception.ExpiredTokenException;
...
import com.B2A4.storybook.global.security.auth.AuthDetails;
...
public class JwtTokenProvider {
    ...
    private final String ISSUER = "B2A4";
    ...
    public String resolveAccessToken(HttpServletRequest request) {
        return resolveCookie(request, "DONGGURI_TOKEN");
    }

    public String resolveRefreshToken(HttpServletRequest request) {
        return resolveCookie(request, "DONGGURI_TOKEN_REFRESH");
    }
