...
const CommentItem = ({ comment, onUpdate, onDelete }) => {
    ...
    const [editText, setEditText] = useState(comment.content);
    const [showActions, setShowActions] = useState(false);
    const [isReportOpen, setIsReportOpen] = useState(false); // 신고 창 상태 관리
    ...
    const handleReport = (event) => {
        ...
        setIsReportOpen(true); // 신고 창 열기
        setShowActions(false); // 액션 메뉴 닫기
    };
    ...
    useEffect(() => {
        console.log("isReportOpen 상태:", isReportOpen);
    }, [isReportOpen]);
    ...
    return (
        <div className="comment-item">
            ...
            {/* 모달은 CommentItem의 최상위 레벨에서 렌더링 */}
            {isReportOpen && (
                <Reports
                    contentId={comment.commentId}
                    contentType="COMMENT"
                    onRequestClose={() => setIsReportOpen(false)} // 신고 창 닫기
                />
            )}
        </div>
    );
